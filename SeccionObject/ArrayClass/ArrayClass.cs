class ArrayClass
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("The first occurrence of 42 is at index " + Array.LastIndexOf(Arr, 42));
        ...
        Array.Reverse(Arr);
        Console.WriteLine("Array taht after reserse");
        for(int i = 0; i < Arr.Length; i++)
        {
            Console.WriteLine("{0} :   {1}", i+1, Arr[1]);
        } 
        Console.ReadLine();
    }
}